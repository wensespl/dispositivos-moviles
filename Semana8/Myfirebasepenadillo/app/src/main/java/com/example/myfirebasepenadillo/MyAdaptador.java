...
public class MyAdaptador extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        return MainActivity.miscontactos.size();
    }
...
//        LayoutInflater layoutInflater=(LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        TextView txtmialias = (TextView) fila.findViewById(R.id.txtmialias);
        ImageView imgImagen = (ImageView) fila.findViewById(R.id.imgimagen);

        txtminombre.setText(MainActivity.miscontactos.get(position).getNombre());
        txtmialias.setText(MainActivity.miscontactos.get(position).getAlias());
        mostrarimagen(imgImagen,MainActivity.miscontactos.get(position).getKey());
